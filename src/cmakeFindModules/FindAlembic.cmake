...
message(STATUS "found half.h in ${ABC_HALF_INCLUDE_DIR}")

message(STATUS "searching Iex in ${ALEMBIC_ILMBASE_ROOT}/lib")
FIND_LIBRARY(ABC_ILMBASE_IEX_LIB NAMES Iex Iex-2_2
    PATHS
...
message(STATUS "found Iex in ${ABC_ILMBASE_IEX_LIB}")

GET_FILENAME_COMPONENT(ABC_ILMBASE_LIBS_PATH ${ABC_ILMBASE_IEX_LIB} DIRECTORY)

FIND_LIBRARY(ABC_ILMBASE_IEX Iex Iex-2_2 PATHS ${ABC_ILMBASE_LIBS_PATH})

message(STATUS "found Iex in ${ABC_ILMBASE_IEX}")

FIND_LIBRARY(ABC_ILMBASE_IEXMATH IexMath IexMath-2_2 PATHS ${ABC_ILMBASE_LIBS_PATH})
...
message(STATUS "found IexMath in ${ABC_ILMBASE_IEXMATH}")
...
message(STATUS "found IlmImf in ${ABC_OPENEXR_LIBS}")
...
message(STATUS "trying to find the all-in-one libAlembic.so")
message(STATUS "looking in ${ALEMBIC_ROOT}")
...
message(STATUS "I AM SEARCHING HERE ${ABC_LIBRARY_DIR}")
