...
int main() {
  ...
  readImage(fs, jpg_filenameL, imageL, EImageColorSpace::NO_CONVERSION);
  readImage(fs, jpg_filenameR, imageR, EImageColorSpace::NO_CONVERSION);
  ...
  //- Draw features on the two image (side by side)
  {
    ...
    writeImage(fs, out_filename, concat, EImageColorSpace::NO_CONVERSION);
  }
