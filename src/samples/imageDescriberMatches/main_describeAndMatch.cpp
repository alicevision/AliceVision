...
int main(int argc, char** argv)
{
    ...
    allParams.add_options()("jpgFilenameL,l", po::value<std::string>(&jpgFilenameL)->required(), "Left image.")(
        "jpgFilenameR,r", po::value<std::string>(&jpgFilenameR)->required(), "Right image.")(
    ...
    const std::vector<PointFeature> featsL = regions_perImage.at(0)->GetRegionsPositions(),
