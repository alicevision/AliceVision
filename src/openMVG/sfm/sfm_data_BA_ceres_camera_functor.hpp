...
struct ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K1
{
    ...
    T* out_residuals) const
  {
    ...
    const T r_coeff = cameras::Pinhole_Intrinsic_Radial_K1::distoCoef(k1, r2);
...
struct ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3
{
    ...
    T* out_residuals) const
  {
    ...
    // Apply distortion (xd,yd) = disto(x_u,y_u)
    const T r2 = x_u*x_u + y_u*y_u;
    const T r_coeff = cameras::Pinhole_Intrinsic_Radial_K3::distoCoef(k1, k2, k3, r2);
    const T x_d = x_u * r_coeff;
    const T y_d = y_u * r_coeff;
...
struct ResidualErrorFunctor_Pinhole_Intrinsic_Radial_PTLens
{
  ResidualErrorFunctor_Pinhole_Intrinsic_Radial_PTLens(const double* const pos_2dpoint)
  {
    m_pos_2dpoint[0] = pos_2dpoint[0];
    m_pos_2dpoint[1] = pos_2dpoint[1];
  }
    ...
    T* out_residuals) const
  {
    ...
    // Apply distortion (xd,yd) = disto(x_u,y_u)
    const T r2 = x_u*x_u + y_u*y_u;
    const T r_coeff = cameras::Pinhole_Intrinsic_Radial_PTLens::distoCoef(k1, k2, k3, r2);
    const T x_d = x_u * r_coeff;
    const T y_d = y_u * r_coeff;
