...
int main(int argc, char** argv)
{
  ...
  desc.add_options()
          ...
          ("featuresDirectory,f", bpo::value<string>(&featuresDirectory),
              "Path to a directory containing the extracted features and descriptors. By default, it is the directory containing the SfMData.")
  ...
  std::size_t numTotFeatures = aliceVision::voctree::populateDatabase<DescriptorUChar>(keylist, featuresDirectory, tree, db, Nmax);
  ...
  else
  {
    ...
    aliceVision::voctree::queryDatabase<DescriptorUChar>(queryList, featuresDirectory, tree, db, numImageQuery, allDocMatches, histograms, distance, Nmax);
  }
