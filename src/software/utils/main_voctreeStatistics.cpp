...
int main(int argc, char** argv)
{
  ...
  size_t numTotFeatures = aliceVision::voctree::populateDatabase<DescriptorUChar>(keylist, featuresDirectory, tree, db);
  ...
  aliceVision::voctree::voctreeStatistics<DescriptorUChar>(queryList, featuresDirectory, tree, db, distance, globalHisto);
