...
int main(int argc, char** argv)
{
  ...
  size_t numTotFeatures = aliceVision::voctree::populateDatabase<DescriptorUChar>(keylist, featuresFolder, tree, db);
  ...
  aliceVision::voctree::voctreeStatistics<DescriptorUChar>(queryList, featuresFolder, tree, db, distance, globalHisto);
