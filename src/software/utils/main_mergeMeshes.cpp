...
EOperationType EOperationType_stringToEnum(const std::string& operationType)
{
    ...
    if (type == "boolean_union")
        return EOperationType::BOOLEAN_UNION;
    if (type == "boolean_intersection")
        return EOperationType::BOOLEAN_INTERSECTION;
    if (type == "boolean_difference")
        return EOperationType::BOOLEAN_DIFFERENCE;
