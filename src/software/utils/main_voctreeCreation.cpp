...
int main(int argc, char** argv)
{
  ...
  desc.add_options()
          ...
          ("keylist,l", po::value<string>(&keylist)->required(), "Path to the list file (list.txt or sfm_data.json) generated by AliceVision or to the folder with the .desc files")
          ("featuresDirectory,f", po::value<string>(&featuresDirectory), "Path to a directory containing the extracted features and descriptors. By default, it is the directory containing the SfMData.")
  ...
  size_t numTotDescriptors = aliceVision::voctree::readDescFromFiles<DescriptorFloat, DescriptorUChar>(keylist, featuresDirectory, descriptors, descRead);
