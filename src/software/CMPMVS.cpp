...
int main(int argc, char* argv[])
{
    ...
    if(cmdline.steps.test(CommandLine::Step::MESHING))
    {
        ...
        if(cmdline.meshingMode == "large")
        {
            ...
            meshConstruction::LargeScale lsbase(&mp, &pc, mip.mvDir + baseDir + "/");
        ...
        if(cmdline.meshingMode == "limited")
        {
            ...
            meshConstruction::LargeScale ls0(&mp, &pc, mip.mvDir + baseDir + "/");
            ...
            while(ntracks > maxPts)
            {
                ...
                meshConstruction::LargeScale* ls = ls0.cloneSpaceIfDoesNotExists(ocTreeDim, dirName);
            ...
            meshConstruction::LargeScale lsbase(&mp, &pc, mip.mvDir + "LargeScaleMaxPts" + common::num2strFourDecimal(ocTreeDim) + "/");
