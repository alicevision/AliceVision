...
public:
    ...
    void getPtsNeighPtsOrdered(StaticVector<StaticVector<int>*>& out_ptsNeighPts) const;
...
public:
    ...
    void getTrianglePixelIntersectionsAndInternalPoints(Mesh::triangle_proj& tp, Mesh::rectangle& re,
                                                              StaticVector<Point2d>& out);
