                        ...
                        Point3d* hexah)
{
    ...
    // copy ptsCams
    {
        ...
        bool doRemoveTrianglesInhexahsToExcludeFromResultingMesh =
          (bool)mp.userParams.get<bool>("LargeScale.doRemoveTrianglesInhexahsToExcludeFromResultingMesh", false);
    ...
    if (true)  // TODO: how to remove it?
    {
        ...
        if (hexah != nullptr)
        {
            ...
            for (int i = 0; i < meOpt.pts.size(); i++)
            {
                ...
                bool isHexahBorderPt = ((x < avel) || (x > svx - avel) || (y < avel) || (y > svy - avel) || (z < avel) || (z > svz - avel));
        ...
        /////////////////////////////
        bool doSmoothMesh = mp.userParams.get<bool>("meshEnergyOpt.doSmoothMesh", true);
