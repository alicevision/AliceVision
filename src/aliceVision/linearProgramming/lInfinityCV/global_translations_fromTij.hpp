...
#ifndef ALICEVISION_LINFINITY_COMPUTER_VISION_GLOBAL_TRANSLATIONS_FROMTIJ_H_
...
//--
inline void EncodeTi_from_tij(const size_t nTranslation,
...
{
    Tifromtij_ConstraintBuilder(const std::vector<translationAveraging::relativeInfo>& vecRelative)
    ...
    bool Build(LPConstraintsSparse& constraint)
    {
        ...
        //  - one gamma parameter.
        constraint._nbParams = _Ncam * 3 + _vecRelative.size() + 1;
        return true;
    }
...
#endif  // ALICEVISION_LINFINITY_COMPUTER_VISION_GLOBAL_TRANSLATIONS_FROMTIJ_H_
