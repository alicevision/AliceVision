...
Eigen::Matrix<double, 2, 2> Undistortion3DERadial4::getDerivativeUndistortNormalizedwrtPoint(const Vec2& p) const
{
    ...
    d_radial_d_pt(0, 0) = c2 * r2 + c4 * r4 + x2 * (2 * c2 + 4 * c4 * r2 + 4.0 * v3 * y) + x * (6.0 * u1 + 6.0 * u3 * r2 + 2 * u3 * (3.0 * x2 + y2)) +
                          y * (2.0 * v1 + 2.0 * v3 * r2) + 1.0;
    d_radial_d_pt(0, 1) =
      x * (2.0 * v1 + 4.0 * v3 * y2 + 2.0 * v3 * r2 + y * (2 * c2 + 4 * c4 * r2)) + y * (2 * u1 + 2 * u3 * r2 + 2 * u3 * (3.0 * x2 + y2));
    d_radial_d_pt(1, 0) =
      4.0 * u3 * x2 * y + x * (2 * v1 + 2 * v3 * r2 + 2 * v3 * (x2 + 3.0 * y2) + y * (2 * c2 + 4 * c4 * r2)) + y * (2.0 * u1 + 2.0 * u3 * r2);
    d_radial_d_pt(1, 1) = c2 * r2 + c4 * r4 + x * (2.0 * u1 + 4.0 * u3 * y2 + 2.0 * u3 * r2) + y2 * (2 * c2 + 4 * c4 * r2) +
                          y * (6.0 * v1 + 6.0 * v3 * r2 + 2 * v3 * (x2 + 3.0 * y2)) + 1.0;
