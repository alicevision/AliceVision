...
enum EINTRINSIC
{
  ...
  EQUIDISTANT_CAMERA_RADIAL1 = 7,
  EQUIDISTANT_CAMERA_RADIAL3 = 8,
  CAMERA_END
};
...
inline std::string EINTRINSIC_enumToString(EINTRINSIC intrinsic)
{
  switch(intrinsic)
  {
    ...
    case EQUIDISTANT_CAMERA_RADIAL1:      return "equidistant_r1";
...
inline EINTRINSIC EINTRINSIC_stringToEnum(const std::string& intrinsic)
{
  ...
  if(type == "equidistant_r1") return EQUIDISTANT_CAMERA_RADIAL1;
