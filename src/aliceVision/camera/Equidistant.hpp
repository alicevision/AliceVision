...
public:
    ...
    double getCircleCenterX() const { return _circleCenter(0); }

    void setCircleCenterX(double x) { _circleCenter(0) = x; }

    double getCircleCenterY() const { return _circleCenter(1); }

    void setCircleCenterY(double y) { _circleCenter(1) = y; }
