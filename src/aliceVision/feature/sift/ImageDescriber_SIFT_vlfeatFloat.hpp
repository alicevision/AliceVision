...
class ImageDescriber_SIFT_vlfeatFloat : public ImageDescriber
{
  public:
    ...
    ~ImageDescriber_SIFT_vlfeatFloat() override { VLFeatInstance::destroy(); }
     ...
     */
    bool useFloatImage() const override { return true; }

    /**
     * @brief Get the corresponding EImageDescriberType
     * @return EImageDescriberType
     */
    EImageDescriberType getDescriberType() const override { return EImageDescriberType::SIFT_FLOAT; }
     ...
     */
    void setConfigurationPreset(ConfigurationPreset preset) override { return _params.setPreset(preset); }
     ...
     */
    void allocate(std::unique_ptr<Regions>& regions) const override { regions.reset(new SIFT_Float_Regions); }
