...
/**
 * @brief Create an Image_describer interface for VLFeat SIFT feature extractor
 */
class SIFT_vlfeat_ImageDescriber : public Image_describer
{
public:
  SIFT_vlfeat_ImageDescriber(const SiftParams& params = SiftParams(), bool isOriented = true)
    : Image_describer()
    , _params(params)
