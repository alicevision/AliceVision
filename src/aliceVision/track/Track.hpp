...
struct TracksUtilsMap
{
   ...
   */
  static bool getCommonTracksInImages(const std::set<std::size_t>& imageIndexes,
   ...
   */  
  static void getCommonTracksInImages(const std::set<std::size_t>& imageIndexes,
   ...
   * @param[out] tracksOut: output with only the common tracks.
   */
  static bool getCommonTracksInImagesFast(const std::set<std::size_t>& imageIndexes,
                                          const TracksMap& tracksIn,
                                          const TracksPerView& tracksPerView,
                                          TracksMap& tracksOut);
   ...
   */
  static void getTracksInImages(const std::set<std::size_t>& imagesId,
   ...
   * @param[out] tracksId the tracks in the images
   */
  static void getTracksInImagesFast(const std::set<IndexT>& imagesId,
                                    const TracksPerView& tracksPerView,
   ...
   */
  static void getTracksInImage(const std::size_t& imageIndex,
                               const TracksMap& tracks,
   ...
   */
  static void getTracksInImageFast(const std::size_t& imageId,
                                   const TracksPerView& tracksPerView,
                                   std::set<std::size_t>& tracksIds)
  {
   ...
   */
  static void computeTracksPerView(const TracksMap& tracks, TracksPerView& tracksPerView);
   ...
   * @param[out] tracksIds
   */
  static void getTracksIdVector(const TracksMap& tracks,
                                std::set<std::size_t>* tracksIds)
  {
    tracksIds->clear();
   ...
   * @return
   */
  static bool getFeatureIdInViewPerTrack(const TracksMap& allTracks,
   ...
   */
  static void tracksToIndexedMatches(const TracksMap& tracks,
   ...
   */
  static void tracksLength(const TracksMap& tracks,
   ...
   * @param[out] imagesId
   */
  static void imageIdInTracks(const TracksPerView& tracksPerView,
   ...
   * @param[out] imagesId
   */
  static void imageIdInTracks(const TracksMap& tracks,
                              std::set<std::size_t>& imagesId)
  {
    for (TracksMap::const_iterator iterT = tracks.begin(); iterT != tracks.end(); ++iterT)
    {
