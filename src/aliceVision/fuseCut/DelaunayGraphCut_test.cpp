...
BOOST_AUTO_TEST_CASE(fuseCut_delaunayGraphCut)
{
    ...
    mvsUtils::MultiViewParams mp(fs, sfmData, "", "", "", false);
    ...
    fuser.divideSpaceFromSfM(sfmData, &hexah[0], minObservations, minObservationsAngle);
    ...
    DelaunayGraphCut delaunayGC(fs, mp);
