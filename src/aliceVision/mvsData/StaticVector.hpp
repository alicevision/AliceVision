...
class StaticVector
{
    ...
    using ConstReference = typename std::vector<T, Allocator>::const_reference;
...
public:
    ...
    const StdVector& getData() const { return _data; }
    StdVector& getDataWritable() { return _data; }
    ...
    void push_back_arr(StaticVector* arr)
    {
