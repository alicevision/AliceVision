...
// defines
texture<unsigned char, 2, cudaReadModeNormalizedFloat> ref_rtex;
texture<unsigned char, 2, cudaReadModeNormalizedFloat> ref_ttex;

Cuda::Array<unsigned char, 2>** ref_triangles_texs_arr;
