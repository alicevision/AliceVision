...
struct cuda_stat3d
{
    ...
    inline __device__ void update(const float3& p, const float& w)
    {
...
private:
    ...
    inline __device__ static double cuda_hypot2(double x, double y)
    {
        return sqrt(x * x + y * y);
    }
    ...
    inline __device__ void cuda_eigen_decomposition(double A[3][3], double V0[], double V1[], double V2[], double d[])
    {
        double e[3];
