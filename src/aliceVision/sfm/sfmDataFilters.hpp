...
static bool eraseUnstablePoses(SfMData & sfm_data, const IndexT min_points_per_pose)
{
...
static bool eraseObservationsWithMissingPoses(SfMData & sfm_data, const IndexT min_points_per_landmark)
{
  IndexT removed_elements = 0;
