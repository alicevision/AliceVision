                                                                 ...
                                                                 matching::PairwiseMatches& tripletWise_matches)
{
  ...
  if(!_loggingFile.empty())
  {
    sfmDataIO::Save(_sfmData,(vfs::path(_loggingFile).parent_path() / "cameraPath_translation_averaging.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS));
  }
...
bool ReconstructionEngine_globalSfM::Adjust()
{
  ...
  {
    if(!_loggingFile.empty())
      sfmDataIO::Save(_sfmData, (vfs::path(_loggingFile).parent_path() / "structure_00_refine_T_Xi.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS | sfmDataIO::STRUCTURE));
    ...
    if(success && !_loggingFile.empty())
      sfmDataIO::Save(_sfmData, (vfs::path(_loggingFile).parent_path() / "structure_01_refine_RT_Xi.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS | sfmDataIO::STRUCTURE));
  }
  ...
  if(success && !_lockAllIntrinsics)
  {
    ...
    if(success && !_loggingFile.empty())
      sfmDataIO::Save(_sfmData, (vfs::path(_loggingFile).parent_path() / "structure_02_refine_KRT_Xi.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS | sfmDataIO::STRUCTURE));
  }
  ...
  if(!_loggingFile.empty())
    sfmDataIO::Save(_sfmData, (vfs::path(_loggingFile).parent_path() / "structure_03_outlier_removed.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS | sfmDataIO::STRUCTURE));
  ...
  if(success && !_loggingFile.empty())
    sfmDataIO::Save(_sfmData, (vfs::path(_loggingFile).parent_path() / "structure_04_outlier_removed.ply").string(), sfmDataIO::ESfMData(sfmDataIO::EXTRINSICS | sfmDataIO::STRUCTURE));
