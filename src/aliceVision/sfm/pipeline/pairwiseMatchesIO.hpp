 ...
 */
inline bool loadPairwiseMatches(vfs::filesystem& fs,
    ...
    bool useOnlyMatchesFromFolder = false)
{
  ...
  if (!matching::Load(fs, out_pairwiseMatches, sfmData.getViewsKeys(), matchesFolders, descTypes, maxNbMatches, minNbMatches))
  {
