...
{
  public:
    CommonDataByPair(const std::string& sLeftImage, const std::string& sRightImage)
      : _sLeftImage(sLeftImage),
        _sRightImage(sRightImage)
    {}
    ...
    static void computeHisto(utils::Histogram<double>& histo,
