                      ...
                      const std::string& customSuffix)
{
    ...
    if(!FileExists(mapFirstTilePath))
                     ...
                     const std::string& customSuffix)
{
    ...
    if(FileExists(depthMapPath) && FileExists(simMapPath))
    {
        using namespace imageIO;
        int w, h;
                                           ...
                                           const std::string& customSuffix)
{
    ...
    if(FileExists(depthMapPath)) // untilled
    {
        oiio::ParamValueList metadata;
    ...
    else // tilled
    {
        ...
        if(!FileExists(depthMapFirstTilePath))
