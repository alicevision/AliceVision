...
template<typename SolverT_,
         ...
         typename ModelT_ = robustEstimation::Mat34Model,
         typename SolverLsT_ = robustEstimation::UndefinedSolver<ModelT_>>
class ResectionKernel : public robustEstimation::PointFittingRansacKernel<SolverT_, ErrorT_, ModelT_, SolverLsT_>
{
  public:
    ...
    double thresholdNormalizer() const override { return _N1(0, 0); }
 ...
 * @tparam UnnormalizerT The functor used to normalize the data before the estimation of the model, usually a functor that normalize the point in
 * camera coordinates (ie multiply by the inverse of the calibration matrix).
...
template<typename SolverT_,
         ...
         typename ModelT_ = robustEstimation::Mat34Model,
         typename SolverLsT_ = robustEstimation::UndefinedSolver<ModelT_>>
class ResectionKernel_K : public robustEstimation::PointFittingRansacKernel<SolverT_, ErrorT_, ModelT_, SolverLsT_>
{
  public:
    using KernelBase = robustEstimation::PointFittingRansacKernel<SolverT_, ErrorT_, ModelT_, SolverLsT_>;
