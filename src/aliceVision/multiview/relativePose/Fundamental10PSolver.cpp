...
int f10e_gb(const Eigen::Matrix<Scalar, 29, 1>& params, Eigen::MatrixBase<Derived>& sols, double pivtol = 1e-16)
{
    ...
    c(6) = params(0) * params(17) + params(1) * params(16) + params(2) * params(15) + params(3) * params(14) - params(4) * params(13) -
           params(5) * params(12) - params(6) * params(11) - params(7) * params(10);
    c(7) = params(0) * params(18) + params(2) * params(16) - params(6) * params(12) - params(8) * params(10);
    c(8) = params(0) * params(19) + params(1) * params(18) + params(2) * params(17) + params(3) * params(16) - params(6) * params(13) -
           params(7) * params(12) - params(8) * params(11) - params(9) * params(10);
    ...
    c(19) = params(1) * params(24) + params(3) * params(23) + params(0) * params(27) + params(2) * params(25) - params(6) * params(21) -
            params(7) * params(20);
    c(20) = params(0) * params(28) + params(1) * params(27) + params(2) * params(26) + params(3) * params(25) - params(6) * params(22) -
            params(7) * params(21);
    ...
    c(31) = params(11) * params(24) + params(13) * params(23) + params(10) * params(27) + params(12) * params(25) - params(16) * params(21) -
            params(17) * params(20);
    c(32) = params(10) * params(28) + params(11) * params(27) + params(12) * params(26) + params(13) * params(25) - params(16) * params(22) -
            params(17) * params(21);
...
int F10RelativePose(const Mat& X, const Mat& U, std::vector<Fundamental10PModel>& models)
{
    ...
    params << mr(5, 0), mr(5, 1), -mr(4, 0), -mr(4, 1), mr(5, 2), mr(5, 3), mr(5, 4) - mr(4, 2), mr(5, 5) - mr(4, 3), -mr(4, 4), -mr(4, 5), mr(7, 0),
      mr(7, 1), -mr(6, 0), -mr(6, 1), mr(7, 2), mr(7, 3), mr(7, 4) - mr(6, 2), mr(7, 5) - mr(6, 3), -mr(6, 4), -mr(6, 5), mr(9, 0),
      mr(9, 1) - mr(8, 0), -mr(8, 1), mr(9, 2), mr(9, 4), mr(9, 3) - mr(8, 2), -mr(8, 3), mr(9, 5) - mr(8, 4), -mr(8, 5);
    ...
    b << mr(5, 0), mr(5, 1), -mr(4, 0), -mr(4, 1), mr(5, 2), mr(5, 3), mr(5, 4) - mr(4, 2), mr(5, 5) - mr(4, 3), -mr(4, 4), -mr(4, 5);
    ...
    for (Eigen::Index i = 0; i < nsols; ++i)
    {
        ...
        L << l1, l2;
        F << m3.dot(-mr.row(0)), m3.dot(-mr.row(1)), m3.dot(-mr.row(9)), m3.dot(-mr.row(2)), m3.dot(-mr.row(3)), f23, m3.dot(-mr.row(5)),
          m3.dot(-mr.row(7)), 1;
