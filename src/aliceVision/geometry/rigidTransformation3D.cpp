...
int lm_SRTRefine_functor::operator()(const Vec& x, Vec& fvec) const
{
    ...
    Mat3 Rcor = (Eigen::AngleAxis<double>(rot(0), Vec3::UnitX()) * Eigen::AngleAxis<double>(rot(1), Vec3::UnitY()) *
                      ...
                      bool refine)
{
    ...
    const std::pair<double, double> ACRansacOut =
      robustEstimation::ACRANSAC(kernel, randomNumberGenerator, vec_inliers, numIterations, &RTS, dPrecision);
