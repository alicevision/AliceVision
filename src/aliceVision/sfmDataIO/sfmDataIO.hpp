...
#define ALICEVISION_SFMDATAIO_VERSION_REVISION 4
...
enum ESfMData
{
  ...
  ALL_DENSE = VIEWS | EXTRINSICS | INTRINSICS | UNDISTORTIONS | STRUCTURE | OBSERVATIONS | CONTROL_POINTS | CONSTRAINTS2D,
  ALL = VIEWS | EXTRINSICS | INTRINSICS | UNDISTORTIONS | STRUCTURE | OBSERVATIONS | OBSERVATIONS_WITH_FEATURES | CONTROL_POINTS | UNCERTAINTY | CONSTRAINTS2D
};
