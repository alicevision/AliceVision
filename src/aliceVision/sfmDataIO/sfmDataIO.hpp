...
#define ALICEVISION_SFMDATAIO_VERSION_REVISION 14
...
enum ESfMData
{
    ...
    ALL = VIEWS | EXTRINSICS | INTRINSICS | STRUCTURE | OBSERVATIONS | OBSERVATIONS_WITH_FEATURES | UNCERTAINTY | CONSTRAINTS2D | ANCESTORS | SURVEYS
};
