...
if(AV_BUILD_FFMPEG)
    ...
    if(APPLE)
        ...
        set(FFMPEG_CFLAGS -I<INSTALL_DIR>/include\ ${APPLE_ARCH_FLAGS}\ -Wl,-headerpad_max_install_names)
        set(FFMPEG_LDFLAGS -L<INSTALL_DIR>/${CMAKE_INSTALL_LIBDIR}\ ${APPLE_ARCH_FLAGS}\ -headerpad_max_install_names)
    else()
