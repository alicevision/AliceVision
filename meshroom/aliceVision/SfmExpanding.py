...
"""
    ...
    inputs = [
        ...
        desc.BoolParam(
            name="enableObservationsDensityWeighting",
            label="Enable observations density weighting",
            description="Enable observations weighting to reduce impact of regions with high point density.",
            value=False,
        ),
        desc.BoolParam(
            name="enableObservationsTrackWeighting",
            label="Enable observations track weighting",
            description="Enable weighting observations depending on their position within the track.",
            value=False,
        ),
        desc.IntParam(
            name="observationsTrackWeightFadingSize",
            label="Observations Track Weight Fading Size",
            description="The fading size used to weight observations based on their temporal position within the track.",
            value=5,
            range=(0, 20, 1),
            advanced=True,
            enabled=lambda node: node.enableObservationsTrackWeighting.value,
        ),
        desc.FloatParam(
            name="trackLengthMaxWeight",
            label="Track Length Max Weight",
            description="The weight to give to long tracks vs. the reference weight of 1 given to shorter tracks.",
            value=5.0,
            range=(1.0, 10.0, 0.1),
            advanced=True,
            enabled=lambda node: node.enableObservationsTrackWeighting.value,
        ...
        desc.IntParam(
            name="trackLengthWeightingLowerThreshold",
            label="Track Length Weighting Lower Threshold",
            description="The number of observations under which a landmark is given a weight of 1.",
            value=5,
            range=(0, 10, 1),
            advanced=True,
            enabled=lambda node: node.enableObservationsTrackWeighting.value,
        ...
        desc.IntParam(
            name="trackLengthWeightingUpperThreshold",
            label="Track Length Weighting Upper Threshold",
            description="The number of observations above which a landmark is given the maximum weight.",
            value=20,
            range=(0, 50, 1),
            advanced=True,
            enabled=lambda node: node.enableObservationsTrackWeighting.value,
