...
- Add rawImageConversion pipeline [PR](https://github.com/alicevision/AliceVision/pull/1946)
- [meshroom] Add new "Lidar Meshing" template [PR](https://github.com/alicevision/AliceVision/pull/1947)
...
- Colorizing node [PR](https://github.com/alicevision/AliceVision/pull/1787)
- [sfm] New sfmFilter software: split sfm based on filenames regex [PR](https://github.com/alicevision/AliceVision/pull/1769)
- [export] Add export of animated distortion in Nuke [PR](https://github.com/alicevision/AliceVision/pull/1767)
- Use lidar as constraints in sfm [PR](https://github.com/alicevision/AliceVision/pull/1803)
- Enable merging of multiple sfms [PR](https://github.com/alicevision/AliceVision/pull/1807)
- [build] SwigBinding: Add support for the Python binding with SWIG on Windows [PR](https://github.com/alicevision/AliceVision/pull/1661)
- New tool to import external Alembic files with an animated camera [PR](https://github.com/alicevision/AliceVision/pull/1848)
- Add masks to export images [PR](https://github.com/alicevision/AliceVision/pull/1856)
- features detector checks for mask in a region [PR](https://github.com/alicevision/AliceVision/pull/1772)
- Add numpy to python bindings [PR](https://github.com/alicevision/AliceVision/pull/1861)
- Add module image to python bindings [PR](https://github.com/alicevision/AliceVision/pull/1877)
- RelativePoseEstimating accepts an image pairs list to reduce complexity [PR](https://github.com/alicevision/AliceVision/pull/1886)
- SwigBinding: Add Python binding for `matchingImageCollection` IO functions [PR](https://github.com/alicevision/AliceVision/pull/1898)
- [sfm] Add new parameters to the SfM process [PR](https://github.com/alicevision/AliceVision/pull/1912)
- [doc] README.md: Add DeepWiki link, the AI documentation you can talk to [PR](https://github.com/alicevision/AliceVision/pull/1938)
...
- Add Bundle Adjustment unit tests [PR](https://github.com/alicevision/AliceVision/pull/1633)
- Remove specifics required by Eigen prior to C++17 [PR](https://github.com/alicevision/AliceVision/pull/1638)
- Remove Boost-Filesystem and replace it with the `std::filesystem` [PR](https://github.com/alicevision/AliceVision/pull/1642)
- Clean-up `.clang-tidy` and apply `camelBack` case on functions and variables for some modules [PR](https://github.com/alicevision/AliceVision/pull/1637)
- Add option to keep input filename in imageSegmentation [PR](https://github.com/alicevision/AliceVision/pull/1636)
- [software] Disable clang-format around program options [PR](https://github.com/alicevision/AliceVision/pull/1643)
- [software] Apply clang-formatting on all the executables [PR](https://github.com/alicevision/AliceVision/pull/1601)
- FeatureExtraction: Add analytical fisheye mask [PR](https://github.com/alicevision/AliceVision/pull/1645)
- [sfmData] Rename functions and files to respect case rules [PR](https://github.com/alicevision/AliceVision/pull/1648)
- Remove all remaining references to Boost-Filesystem [PR](https://github.com/alicevision/AliceVision/pull/1650)
- Add aarch64 support (adjust PR1616) [PR](https://github.com/alicevision/AliceVision/pull/1655)
- Add camera color spaces [PR](https://github.com/alicevision/AliceVision/pull/1597)
- Rename Python `aliceVision` module into `pyalicevision` [PR](https://github.com/alicevision/AliceVision/pull/1667)
- E57 importer is now generating multiple sfmData [PR](https://github.com/alicevision/AliceVision/pull/1666)
- Clean and rework meshing code [PR](https://github.com/alicevision/AliceVision/pull/1672)
- [sfm] Handle specific alignment case for pure translations [PR](https://github.com/alicevision/AliceVision/pull/1673)
- [sfm] Sequential: Update default value for Ransac's max iterations [PR](https://github.com/alicevision/AliceVision/pull/1683)
- [keyframe] Set default values for some uninitialized variables [PR](https://github.com/alicevision/AliceVision/pull/1685)
- [aliceVision] Minor bugfixes across the project [PR](https://github.com/alicevision/AliceVision/pull/1684)
- SwigBinding: Extend the binding of `camera` and add initial binding for other modules [PR](https://github.com/alicevision/AliceVision/pull/1674)
- Option to Remove absolute paths to linked libraries [PR](https://github.com/alicevision/AliceVision/pull/1691)
- [software] New SelectConnectedViews software [PR](https://github.com/alicevision/AliceVision/pull/1692)
- [software] KeyframeSelection: Update default minimum number of keyframes [PR](https://github.com/alicevision/AliceVision/pull/1694)
- [mesh] visibility from mesh itself: check point is in camera frustum [PR](https://github.com/alicevision/AliceVision/pull/1695)
- Catch error codes thrown by `std::filesystem::exists`  [PR](https://github.com/alicevision/AliceVision/pull/1687)
- Add missing standard header include [PR](https://github.com/alicevision/AliceVision/pull/1705)
- Export radial3 distortion to nuke [PR](https://github.com/alicevision/AliceVision/pull/1693)
- [pipeline] FeatureMatching: Update default value for Ransac's maximum number of iterations [PR](https://github.com/alicevision/AliceVision/pull/1707)
- [Cmake] split sfm library [PR](https://github.com/alicevision/AliceVision/pull/1717)
- [sfm] update tracks [PR](https://github.com/alicevision/AliceVision/pull/1716)
- Solve a set of bugs on cameraInit [PR](https://github.com/alicevision/AliceVision/pull/1726)
- anisotropic bounds for sfm [PR](https://github.com/alicevision/AliceVision/pull/1725)
- Add SfM Expanding application [PR](https://github.com/alicevision/AliceVision/pull/1718)
- ApplyCalibration: Add option to use a Lens calibration file from 3dequalizer in json [PR](https://github.com/alicevision/AliceVision/pull/1735)
- Use focal length from json and fix typos in parameters [PR](https://github.com/alicevision/AliceVision/pull/1741)
- Add locks for intrinsics [PR](https://github.com/alicevision/AliceVision/pull/1737)
- sfmTransform: Add option to lineup camera motion with object/lidar given an external camera pose [PR](https://github.com/alicevision/AliceVision/pull/1742)
- Distortion export for pipelines without lens grids [PR](https://github.com/alicevision/AliceVision/pull/1750)
- [hdr] Upgrade on HDR brackets estimation [PR](https://github.com/alicevision/AliceVision/pull/1751)
- Clean up focal length and change anamorphic model [PR](https://github.com/alicevision/AliceVision/pull/1745)
- [sfmData] ImageInfo: Add support for ARRI- and DJI-specific focal length metadata [PR](https://github.com/alicevision/AliceVision/pull/1759)
- Depth/normal maps rendering from Mesh [PR](https://github.com/alicevision/AliceVision/pull/1752)
- Remove imageCache code from alicevision [PR](https://github.com/alicevision/AliceVision/pull/1755)
- [utils] Pose injection from JSON file [PR](https://github.com/alicevision/AliceVision/pull/1780)
- Merge symbolic and automatic SfM [PR](https://github.com/alicevision/AliceVision/pull/1778)
- Add global rotation estimation app [PR](https://github.com/alicevision/AliceVision/pull/1773)
- Add SWIG binding of camera shared pointers [PR](https://github.com/alicevision/AliceVision/pull/1788)
- Adding logs to sfmExpanding [PR](https://github.com/alicevision/AliceVision/pull/1795)
- [docker] Fix export of `ALICEVISION_*` environment variables [PR](https://github.com/alicevision/AliceVision/pull/1797)
- Build OpenCV with FFmpeg on Linux [PR](https://github.com/alicevision/AliceVision/pull/1784)
- [docker] Update CUDA minor version to 12.1.1 [PR](https://github.com/alicevision/AliceVision/pull/1799)
- Clarify check-cpu.sh documentation [PR](https://github.com/alicevision/AliceVision/pull/1791)
- Update sfmBootstraping parameters [PR](https://github.com/alicevision/AliceVision/pull/1794)
- Add Equirectangular camera support for SFM [PR](https://github.com/alicevision/AliceVision/pull/1801)
- sfmMerge can merge Intrinsics [PR](https://github.com/alicevision/AliceVision/pull/1815)
- Mask processing app [PR](https://github.com/alicevision/AliceVision/pull/1814)
- Fix typos in README and PR template [PR](https://github.com/alicevision/AliceVision/pull/1821)
- Output second sfm for visualisation [PR](https://github.com/alicevision/AliceVision/pull/1818)
- Fix typos in src/aliceVision [PR](https://github.com/alicevision/AliceVision/pull/1822)
- Reduce intrication of distortion with intrinsics [PR](https://github.com/alicevision/AliceVision/pull/1819)
- Adding logs to export USD [PR](https://github.com/alicevision/AliceVision/pull/1823)
- Fix typos in src/software [PR](https://github.com/alicevision/AliceVision/pull/1826)
- Fix source typo in software/pipeline/main_lightingCalibration.cpp [PR](https://github.com/alicevision/AliceVision/pull/1825)
- Fix various remaining typos [PR](https://github.com/alicevision/AliceVision/pull/1830)
- fix sfmMerge [PR](https://github.com/alicevision/AliceVision/pull/1829)
- Versatile image exporting [PR](https://github.com/alicevision/AliceVision/pull/1828)
- Fix error on generated depthmap EXR [PR](https://github.com/alicevision/AliceVision/pull/1816)
- Upgrade compilation options and CI for C++20 support [PR](https://github.com/alicevision/AliceVision/pull/1834)
- Multiple lineup at different frames [PR](https://github.com/alicevision/AliceVision/pull/1824)
- Fix some remaining typos [PR](https://github.com/alicevision/AliceVision/pull/1835)
- Remove unused "ci" folder [PR](https://github.com/alicevision/AliceVision/pull/1842)
- [sfmDataIO] Fix Alembic dependency requirement for unit test [PR](https://github.com/alicevision/AliceVision/pull/1841)
- Survey Injection [PR](https://github.com/alicevision/AliceVision/pull/1839)
- [meshroom] Add AliceVision nodes and templates for Meshroom  [PR](https://github.com/alicevision/AliceVision/pull/1845)
- Reduce compilation warnings and clean-up files [PR](https://github.com/alicevision/AliceVision/pull/1844)
- [meshroom] ExtractMetadata: Move `pyalicevision` import into the `processChunk` method [PR](https://github.com/alicevision/AliceVision/pull/1851)
- [docker] Copy `meshroom` folder to be able to install nodes and templates [PR](https://github.com/alicevision/AliceVision/pull/1853)
- Color checker detection and correction update [PR](https://github.com/alicevision/AliceVision/pull/1852)
- Fix division zero at Texturing [PR](https://github.com/alicevision/AliceVision/pull/1857)
- Add `TracksMerging` node and partially add the tracks module to the Python binding [PR](https://github.com/alicevision/AliceVision/pull/1864)
- Deep merging of multiple tracks sets without using original matches [PR](https://github.com/alicevision/AliceVision/pull/1865)
- [utils] Image Processing: Add simultaneous support for regex and input folders [PR](https://github.com/alicevision/AliceVision/pull/1774)
- Add application to generate virtual tracks [PR](https://github.com/alicevision/AliceVision/pull/1862)
- Upgrade experimental pipelines for better integration in Meshroom [PR](https://github.com/alicevision/AliceVision/pull/1870)
- [docker] Ubuntu: Use CMake from standard repo instead of Kitware's [PR](https://github.com/alicevision/AliceVision/pull/1874)
- [meshroom] CamTrack: Provide `PrepareDenseScene` with segmentation masks [PR](https://github.com/alicevision/AliceVision/pull/1878)
- [sfmData] Add focal length naming convention [PR](https://github.com/alicevision/AliceVision/pull/1884)
- Global binding [PR](https://github.com/alicevision/AliceVision/pull/1882)
- [utils] Optimize `exportImages` application when only undistort is needed [PR](https://github.com/alicevision/AliceVision/pull/1893)
- [meshroom] `SketchfabUpload`: Import `requests` at the function-level [PR](https://github.com/alicevision/AliceVision/pull/1895)
- Update image module of Python binding [PR](https://github.com/alicevision/AliceVision/pull/1899)
- SwigBinding: Add binding for the `feature` and `matching` modules [PR](https://github.com/alicevision/AliceVision/pull/1900)
- [meshroom] Use CamelCase for all attribute labels [PR](https://github.com/alicevision/AliceVision/pull/1903)
- Update python test with oiio metadata writing [PR](https://github.com/alicevision/AliceVision/pull/1901)
- Add more logging to new pipeline [PR](https://github.com/alicevision/AliceVision/pull/1905)
- Output modified sfmData in exportImages [PR](https://github.com/alicevision/AliceVision/pull/1907)
- Force Pixel Aspect Ratio in Distortion Calibration [PR](https://github.com/alicevision/AliceVision/pull/1915)
- Improve SWIG Module Type Sharing for Enhanced Interoperability [PR](https://github.com/alicevision/AliceVision/pull/1918)
- [blender] Fix .obj import for blender 4 [PR](https://github.com/alicevision/AliceVision/pull/1910)
- Improving python bindings for image and feature modules [PR](https://github.com/alicevision/AliceVision/pull/1916)
- SwigBinding: Add support of Landmarks [PR](https://github.com/alicevision/AliceVision/pull/1920)
-  SwigBinding: Expose ProgressDisplay [PR](https://github.com/alicevision/AliceVision/pull/1925)
- Add parallelization tool to optimize chunk computation distribution [PR](https://github.com/alicevision/AliceVision/pull/1926)
- [meshroom] Fix missing connection in "CameraTracking without calibration experimental" pipeline [PR](https://github.com/alicevision/AliceVision/pull/1929)
- [meshroom] `ImportAlembic`: Add missing period in file extensions [PR](https://github.com/alicevision/AliceVision/pull/1937)
- [meshroom] ScenePreview: Hide backfaces in 3D render [PR](https://github.com/alicevision/AliceVision/pull/1908)
- [meshroom] `MultiViewPhotometricStereo`: Add missing `Publish` node [PR](https://github.com/alicevision/AliceVision/pull/1942)
- [nodes] Blender: Rescale rendered images based on their pixel aspect ratio [PR](https://github.com/alicevision/Meshroom/pull/2274)
- [nodes] ExportDistortion: Option to export lens grid undistorted [PR](https://github.com/alicevision/Meshroom/pull/2276)
- [nodes] ImageProcessing: New option to apply the Pixel Aspect Ratio [PR](https://github.com/alicevision/Meshroom/pull/2273)
- [pipelines] Enable `Keep Filename` for all `ImageSegmentation` nodes in templates [PR](https://github.com/alicevision/Meshroom/pull/2294)
- [pipelines] Panorama: Enable "Minimal 2D Motion" for `FeatureMatching` [PR](https://github.com/alicevision/Meshroom/pull/2296)
- [pipelines] PanoramaFisheyeHdr: Run `FeatureExtraction` after `PanoramaInit` [PR](https://github.com/alicevision/Meshroom/pull/2299)
- [pipelines] PhotogAndCamTrack: Update matching mode to "Exhaustive" [PR](https://github.com/alicevision/Meshroom/pull/2298)
- [nodes] ImageSegmentation: Support loading masks in 2D Viewer if they are named after the input images [PR](https://github.com/alicevision/Meshroom/pull/2295)
- [nodes] CameraInit: check allowedCameraModels validity [PR](https://github.com/alicevision/Meshroom/pull/2311)
- [nodes] Use utilitary constants for common `ChoiceParams` lists of values [PR](https://github.com/alicevision/Meshroom/pull/2314)
- [nodes] ExportAnimatedCameras: rename as ST maps (instead of UV) [PR](https://github.com/alicevision/Meshroom/pull/2335)
- [pipelines] NodalTracking: Apply masks in `ScenePreview` [PR](https://github.com/alicevision/Meshroom/pull/2322)
- [nodes] New node MeshRemoveUnseenFaces [PR](https://github.com/alicevision/Meshroom/pull/2337)
- [nodes] StructureFromMotion: Update default value for the maximum number of Ransac iterations [PR](https://github.com/alicevision/Meshroom/pull/2341)
- [nodes] CameraInit: Separate Camera and Distortion Types in Model Naming [PR](https://github.com/alicevision/Meshroom/pull/2340)
- [nodes] Update the ressources needs for the SFM node [PR](https://github.com/alicevision/Meshroom/pull/2352)
- [nodes] New SelectConnectedViews node [PR](https://github.com/alicevision/Meshroom/pull/2351)
- [nodes] KeyframeSelection: Update default minimum number of keyframes [PR](https://github.com/alicevision/Meshroom/pull/2354)
- [nodes] ExportanimatedCamera: change default value for the principal point correction [PR](https://github.com/alicevision/Meshroom/pull/2357)
- [nodes] FeatureMatching: Update default value for the maximum number of Ransac iterations [PR](https://github.com/alicevision/Meshroom/pull/2368)
- [nodes] ImageProcessing : use keepImageFilename attribute [PR](https://github.com/alicevision/Meshroom/pull/2417)
- [nodes] Fix outputImages if no export in ExportAnimatedCamera [PR](https://github.com/alicevision/Meshroom/pull/2428)
- [nodes] Blender scripts: Add missing `__init__.py` [PR](https://github.com/alicevision/Meshroom/pull/2433)
- [nodes] SphereDetection: Increase max value for `sphereRadius` [PR](https://github.com/alicevision/Meshroom/pull/2465)
- [nodes] Use principal point in scenePreview [PR](https://github.com/alicevision/Meshroom/pull/2513)
- [nodes] ApplyCalibration: Add option to use a Lens calibration file from 3dequalizer in json [PR](https://github.com/alicevision/Meshroom/pull/2515)
- [pipelines] Add distortion export for templates without calibration [PR](https://github.com/alicevision/Meshroom/pull/2543)
- [nodes] Use bindings for HDR brackets estimation [PR](https://github.com/alicevision/Meshroom/pull/2554)
- [nodes] `LightingCalibration`: Exclude visualization output from command line [PR](https://github.com/alicevision/Meshroom/pull/2567)
- [nodes] LdrToHdr: Move import of `pyalicevision` within functions [PR](https://github.com/alicevision/Meshroom/pull/2569)
- [nodes] Add new `SfMChecking` node [PR](https://github.com/alicevision/Meshroom/pull/2588)
- [pipelines] PhotogCamTrack: Invert masks for segmentation [PR](https://github.com/alicevision/Meshroom/pull/2603)
- [nodes] Add Global Rotation Estimating node [PR](https://github.com/alicevision/Meshroom/pull/2590)
- [nodes] `ExportDistortion`: Add animated distortion option [PR](https://github.com/alicevision/Meshroom/pull/2579)
- [nodes] Fixed spelling mistake in FeatureExtraction.py [PR](https://github.com/alicevision/Meshroom/pull/2648)
- [pipelines] Experimental: Align and set colors for all nodes [PR](https://github.com/alicevision/Meshroom/pull/2681)
- [nodes] Add nodes for versatile image exporting [PR](https://github.com/alicevision/Meshroom/pull/2668)
- [nodes] Replace `desc.Node.internalFolder` with `{nodeCacheFolder}` [PR](https://github.com/alicevision/Meshroom/pull/2693)
- [pipelines] Nodal Camera Tracking: Add a new template with the calibration of the distortion  [PR](https://github.com/alicevision/Meshroom/pull/2271)
- [nodes] Add new `SfMPoseInjecting` node [PR](https://github.com/alicevision/Meshroom/pull/2597)
- [meshroom] Fix `ambient` typo on MVPS template [PR](https://github.com/alicevision/AliceVision/pull/1931)
...
- fix camera pose lock I/O [PR](https://github.com/alicevision/AliceVision/pull/1701)
- Fix pipeline when LdrToHdrMerge is used on single brackets [PR](https://github.com/alicevision/AliceVision/pull/1706)
- Fix crash on convert distortion [PR](https://github.com/alicevision/AliceVision/pull/1711)
- Minor checks and log [PR](https://github.com/alicevision/AliceVision/pull/1719)
- [image] Fix erroneous color space detection for images that contain "raw" in their filepath [PR](https://github.com/alicevision/AliceVision/pull/1728)
- Fix SfM when using undistortions [PR](https://github.com/alicevision/AliceVision/pull/1729)
- Add missing `fstream` include in ApplyCalibration [PR](https://github.com/alicevision/AliceVision/pull/1739)
- [software] PanoramaSeams: Check that the input is not empty [PR](https://github.com/alicevision/AliceVision/pull/1740)
- Inverted flag check in intrinsics [PR](https://github.com/alicevision/AliceVision/pull/1743)
- fix alembic I/O [PR](https://github.com/alicevision/AliceVision/pull/1744)
- [utils] Fix applyCalibration logic for isDesqueezed [PR](https://github.com/alicevision/AliceVision/pull/1758)
- [pipeline] sfmBootstraping: Fix inversion between min and max [PR](https://github.com/alicevision/AliceVision/pull/1768)
- [FuseCut] Fix: Check cam vertex validity in meshing [PR](https://github.com/alicevision/AliceVision/pull/1798)
- Add standard include for fstream [PR](https://github.com/alicevision/AliceVision/pull/1808)
- [segmentation] Image segmentation CPU bugfix and ONNX output update [PR](https://github.com/alicevision/AliceVision/pull/1783)
- fixed bug in sfmExpanding [PR](https://github.com/alicevision/AliceVision/pull/1827)
- SfmBootstrapping: Fix bug when parallax angles are less than 1 degree [PR](https://github.com/alicevision/AliceVision/pull/1831)
- Update minimal required CMake version to 3.5 for all modules [PR](https://github.com/alicevision/AliceVision/pull/1854)
- [src] Fix dependencies depending on build options [PR](https://github.com/alicevision/AliceVision/pull/1855)
- [track] Use `std::map` instead of ` std::unordered_map` to represent Tracks [PR](https://github.com/alicevision/AliceVision/pull/1868)
- Update SWIG code to remove errors [PR](https://github.com/alicevision/AliceVision/pull/1869)
- [docker] Dependencies: Add a symlink to `python3` to make `python` callable [PR](https://github.com/alicevision/AliceVision/pull/1867)
- [image] Remove `static` keyword from `isSupported` and `getSupportedExtensions` [PR](https://github.com/alicevision/AliceVision/pull/1871)
- [fix] Remove invalid default value in ldr2hdrCalibration [PR](https://github.com/alicevision/AliceVision/pull/1872)
- [Dependencies] Adapt code to new Eigen [PR](https://github.com/alicevision/AliceVision/pull/1873)
- Fix bug in sfmMerge [PR](https://github.com/alicevision/AliceVision/pull/1891)
- [mesh] Fix mesh appearing whitened in 3D viewer [PR](https://github.com/alicevision/AliceVision/pull/1892)
- [MVS] meshPostProcessing: bugfix in the cleanup of removed free points [PR](https://github.com/alicevision/AliceVision/pull/1890)
- [sfm] statistics: fix statistics to avoid troubles in particular cases [PR](https://github.com/alicevision/AliceVision/pull/1688)
- Update experimental pipelines [PR](https://github.com/alicevision/AliceVision/pull/1889)
- Remove hack with Custom camera model [PR](https://github.com/alicevision/AliceVision/pull/1897)
- [pipeline] Adding missing link in photogrammetry pipeline [PR](https://github.com/alicevision/AliceVision/pull/1902)
- [Fix] Initialize resectionid depending on previous sfm [PR](https://github.com/alicevision/AliceVision/pull/1904)
- Update json utility functions [PR](https://github.com/alicevision/AliceVision/pull/1917)
- Remove error or warning for some compilers [PR](https://github.com/alicevision/AliceVision/pull/1921)
- Fix nodal pipeline including scenePreview crash [PR](https://github.com/alicevision/AliceVision/pull/1924)
- Update the solver's parameters for more robust unit tests [PR](https://github.com/alicevision/AliceVision/pull/1934)
- [meshroom] `PhotogrammetryObjectTwoSides`: Remove hard-coded paths to models [PR](https://github.com/alicevision/AliceVision/pull/1950)
...
- [build] Update Geogram to 1.8.8 [PR](https://github.com/alicevision/AliceVision/pull/1664)
- Fix coverage in cmake [PR](https://github.com/alicevision/AliceVision/pull/1682)
- Update boost and oiio dependencies [PR](https://github.com/alicevision/AliceVision/pull/1703)
- Remove OpenMesh from internal dependencies [PR](https://github.com/alicevision/AliceVision/pull/1699)
- Add condition to check dependency MeshSDFilter folder [PR](https://github.com/alicevision/AliceVision/pull/1704)
- libE57Format in Copying.md [PR](https://github.com/alicevision/AliceVision/pull/1723)
- Externalize nanoflann [PR](https://github.com/alicevision/AliceVision/pull/1736)
- MeshSDFilter: Remove submodule [PR](https://github.com/alicevision/AliceVision/pull/1738)
- [ci] Windows: Add appropriate flags to compile with CUDA < 12.1  [PR](https://github.com/alicevision/AliceVision/pull/1754)
- [build] Fix some C++17 incompabilities [PR](https://github.com/alicevision/AliceVision/pull/1761)
- [build] Update SWIG version to 4.3.0 [PR](https://github.com/alicevision/AliceVision/pull/1766)
- CI: Move from CentOS to Ubuntu for Linux [PR](https://github.com/alicevision/AliceVision/pull/1785)
- [docker] Add Dockerfiles for Rocky 9 [PR](https://github.com/alicevision/AliceVision/pull/1793)
- [cmake] Update download link for Boost 1.84.0 [PR](https://github.com/alicevision/AliceVision/pull/1802)
- [src] Comply with nanoflann >= 1.6.0 changes [PR](https://github.com/alicevision/AliceVision/pull/1836)
- [ci] Windows: Only install necessary components from the CUDA Toolkit [PR](https://github.com/alicevision/AliceVision/pull/1837)
- [ci] Windows: Update vcpkg archive with latest dependencies versions [PR](https://github.com/alicevision/AliceVision/pull/1838)
- [ci] Windows: Update vcpkg archive with SWIG support [PR](https://github.com/alicevision/AliceVision/pull/1840)
- [ci] Update the path to the segmentation nodes for Meshroom in the CI [PR](https://github.com/alicevision/AliceVision/pull/1847)
- Update minimal required CMake version to 3.5 for all modules [PR](https://github.com/alicevision/AliceVision/pull/1854)
- [src] Fix dependencies depending on build options [PR](https://github.com/alicevision/AliceVision/pull/1855)
- [track] Use `std::map` instead of ` std::unordered_map` to represent Tracks [PR](https://github.com/alicevision/AliceVision/pull/1868)
- Update SWIG code to remove errors [PR](https://github.com/alicevision/AliceVision/pull/1869)
- [docker] Dependencies: Add a symlink to `python3` to make `python` callable [PR](https://github.com/alicevision/AliceVision/pull/1867)
- Dependencies update [PR](https://github.com/alicevision/AliceVision/pull/1883)
- [src] Update DLL discovery in `__init__.py` for the binding on Windows [PR](https://github.com/alicevision/AliceVision/pull/1894)
- Update Dockerfiles [PR](https://github.com/alicevision/AliceVision/pull/1888)
- [docker] rocky: update gxx and enable cctag [PR](https://github.com/alicevision/AliceVision/pull/1906)
- [ci] Windows: Update vcpkg archive with 2025.07.08 tag [PR](https://github.com/alicevision/AliceVision/pull/1909)
- [build] Enable the build of OpenCV's and OpenImageIO's Python bindings [PR](https://github.com/alicevision/AliceVision/pull/1923)
- [doc] Update `INSTALL.md` [PR](https://github.com/alicevision/AliceVision/pull/1935)
- [doc] README.md: Add DeepWiki link, the AI documentation you can talk to [PR](https://github.com/alicevision/AliceVision/pull/1938)
- [cmake] Dependencies: Update OpenCV to 4.12.0 [PR](https://github.com/alicevision/AliceVision/pull/1941)
...
- [cameraSensors] fix Samsung SM-G998B [PR](https://github.com/alicevision/AliceVision/pull/1449)
- [cameraSensors] Add DJI Mini 2 SE [PR](https://github.com/alicevision/AliceVision/pull/1676)
- Added insta360 x3 sensor to db [PR](https://github.com/alicevision/AliceVision/pull/1733)
- [sensordb] Fix typo of 'OnePlus' devices [PR](https://github.com/alicevision/AliceVision/pull/1713)
- [sensordb] OnePlus 8 Pro [PR](https://github.com/alicevision/AliceVision/pull/1709)
- Fix Sonx RX0 II camera model [PR](https://github.com/alicevision/AliceVision/pull/1749)
- Update cameraSensors.db Sony ILCE-6700 [PR](https://github.com/alicevision/AliceVision/pull/1771)
- Update cameraSensors.db [PR](https://github.com/alicevision/AliceVision/pull/1763)
- Update cameraSensors.db DJI Mini3Pro [PR](https://github.com/alicevision/AliceVision/pull/1753)
- Update cameraSensors.db with Pixel 8 and Pixel 8 Pro [PR](https://github.com/alicevision/AliceVision/pull/1764)
- Update cameraSensors.db [PR](https://github.com/alicevision/AliceVision/pull/1846)

### Contributors

[ahdistefano](https://github.com/ahdistefano), [albertoporri](https://github.com/albertoporri), [Alxiice](https://github.com/Alxiice), [AncoraIo36](https://github.com/AncoraIo36), [andrewgreen5610](https://github.com/andrewgreen5610), [apirek](https://github.com/apirek), [Armado001](https://github.com/Armado001), [balloonalpha](https://github.com/balloonalpha), [c-ewing](https://github.com/c-ewing), [Cal-Bur](https://github.com/Cal-Bur), [cbentejac](https://github.com/cbentejac), [CedricThebault](https://github.com/CedricThebault), [demoulinv](https://github.com/demoulinv), [Erol444](https://github.com/Erol444), [EternalUnderperformer](https://github.com/EternalUnderperformer), [fabiencastan](https://github.com/fabiencastan), [heyvian](https://github.com/heyvian), [ICIbrahim](https://github.com/ICIbrahim), [JackBoosY](https://github.com/JackBoosY), [jmelou](https://github.com/jmelou), [luzpaz](https://github.com/luzpaz), [maggo1404](https://github.com/maggo1404), [male4a](https://github.com/male4a), [mh0g](https://github.com/mh0g), [natowi](https://github.com/natowi), [NicholasFlamy](https://github.com/NicholasFlamy), [paweller](https://github.com/paweller), [predat](https://github.com/predat), [servantftransperfect](https://github.com/servantftransperfect), [simogasp](https://github.com/simogasp), [theremygit](https://github.com/theremygit), [woutkolkman](https://github.com/woutkolkman)
