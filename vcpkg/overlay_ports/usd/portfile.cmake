...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    # Move plugInfo.json from lib to bin
    file(RENAME ${CURRENT_PACKAGES_DIR}/lib/usd/plugInfo.json ${CURRENT_PACKAGES_DIR}/bin/usd/plugInfo.json)
    if(NOT VCPKG_BUILD_TYPE)
        file(RENAME ${CURRENT_PACKAGES_DIR}/debug/lib/usd/plugInfo.json ${CURRENT_PACKAGES_DIR}/debug/bin/usd/plugInfo.json)
    endif()
