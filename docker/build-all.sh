...
CUDA_VERSION=11.0.3 UBUNTU_VERSION=20.04 docker/build-ubuntu.sh
CUDA_VERSION=11.0.3 UBUNTU_VERSION=18.04 docker/build-ubuntu.sh
...
CUDA_VERSION=11.0.3 CENTOS_VERSION=7 docker/build-centos.sh
